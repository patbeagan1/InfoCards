...
Welcome to ``imdbscraper`` contributor's guide.
...
If you experience bugs or general issues with ``imdbscraper``, please have a look
...
You can help improve ``imdbscraper`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``imdbscraper`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``imdbscraper``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n imdbscraper python=3 six virtualenv pytest pytest-cov
    conda activate imdbscraper
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/imdbscraper.git
    cd imdbscraper
...
#. Install |pre-commit|_::
   ...
   ``imdbscraper`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/imdbscraper
.. _issue tracker: https://github.com/<USERNAME>/imdbscraper/issues
.. <-- end -->
